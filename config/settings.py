"""
Configuration Django pour le projet UGANC
...
INSTALLED_APPS = [
    ...
    # Apps du projet
    'apps.authentication',
    'apps.gestion_academique',
    'apps.gestion_notes',
    'apps.structure_pedagogique',
    'apps.bulletins',
]
...
# Database
# PostgreSQL pour production (Render), SQLite3 pour développement local
